...
function parseArgs(argv=process.argv.slice(2)){
  ...
  else if(out.providerBaseUrl)throw error('--provider-base-url is only valid for openai-compatible');
