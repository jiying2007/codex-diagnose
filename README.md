...
`product-contract.json` is the machine-checked identity for v1.5.1:

- Diagnose: **1.5.2**
- Safe Core: exact commit `00403dd14877e978698c63d06f6dbdfe2ba9b8cc` / v4.16.0
- Safe Contract: **v2**
