...
const expected=['README.md','README.zh-CN.md','LICENSE','SECURITY.md','ARCHITECTURE.md','VERIFY_RELEASE.md','product-contract.json','src/*.js','src/codex-safe-core/index.js','src/codex-safe-core/safe-contract.js','src/codex-safe-core/codex-runtime.js','src/codex-safe-core/codex-runtime-resolver.js','src/codex-safe-core/codex-cli.js','src/codex-safe-core/process-runner.js','src/codex-safe-core/efficiency-planner.js','src/codex-safe-core/diagnosis-platform.js','src/codex-safe-core/core-contract.json','src/codex-safe-core/family-non-goals.json','src/codex-safe-core/family-error-taxonomy.json','src/codex-safe-core/scripts/family-diagnostics.js'];assert.deepEqual(pkg.files,expected);
...
assert.match(args,/providerMode:'auto'/);assert.match(args,/publish:false/);assert.match(args,/notifyWebhookEnv:''/);assert.match(codex,/codex-runtime-resolver/);assert.match(codex,/resolveCodexRuntime/);assert.match(notify,/open\.feishu\.cn/);assert.match(notify,/qyapi\.weixin\.qq\.com/);assert.match(diagnose,/MAX_FAILED_JOBS=12/);assert.match(diagnose,/MAX_LOCAL_LOG_BYTES=32\*1024\*1024/);
...
console.log(`Codex Diagnose Safe ${contract.diagnoseVersion}: Safe Core ${contract.safeCoreCommit}, Runtime/Provider Contract v3, Diagnosis Receipt v${contract.diagnosisReceiptVersion}, zero-authority CI diagnosis boundary verified.`);
