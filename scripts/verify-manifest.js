...
for(const file of ['README.md','README.zh-CN.md','SECURITY.md','ARCHITECTURE.md']){const text=fs.readFileSync(path.join(root,file),'utf8');assert.doesNotMatch(text,/PR\/MR description generator|生成 PR\/MR 描述/i);}
